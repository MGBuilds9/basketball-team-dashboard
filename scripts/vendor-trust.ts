...
export const TRUSTED_VENDOR_POLICY = {
  ...
  packages: [
    {
      ...
      file: "basketball-os-public-contracts-0.1.0.tgz",
      sha256:
        "9107dee849791427c10ef512786e30e95b8c8d7b9b8fabc21b93cff77113d43a",
      exports: {
        ".": {
    ...
    },
    {
      ...
      file: "basketball-os-team-release-0.1.0.tgz",
      sha256:
        "1b4ca2f86c28811078ad22e9a0844b13a4ffe548e9db571ed459977973fe34f5",
      exports: {
        ".": {
          types: "./dist/index.d.ts",
          import: "./dist/index.js",
  ...
  ] satisfies readonly TrustedVendorPackage[],
} as const
